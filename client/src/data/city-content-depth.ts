...
export const cityContentDepth: CityContentDepth[] = [
  ...
  // ─── CALIFORNIA ───────────────────────────────────────────────────────────────
  {
    ...
    localFaq: [
      { q: "Can I cancel my solar contract in Los Angeles, California?", a: "Yes. Los Angeles homeowners have some of the strongest cancellation rights in the country under the California Consumer Legal Remedies Act (CLRA), the Unfair Competition Law (UCL), and the Home Solicitation Sales Act. NEM 3.0 changes, PACE loan issues, and SunPower/Vivint bankruptcies have created strong grounds for many LA homeowners. A free case review identifies your specific options." },
      { q: "How do I get out of a solar contract in Los Angeles?", a: "Getting out of a solar contract in LA typically involves: (1) legal cancellation based on NEM 3.0 misrepresentation, PACE loan non-disclosure, or other deceptive practices, (2) buyout of the remaining balance, or (3) lease transfer to a home buyer. California law provides the strongest consumer protections in the country for solar contract disputes." },
  ...
  },
  {
    ...
    localFaq: [
      { q: "Can I cancel my solar contract in Phoenix, Arizona?", a: "Yes. Phoenix homeowners have multiple legal grounds to cancel solar contracts, including the Arizona Consumer Fraud Act (A.R.S. § 44-1521), the FTC Cooling-Off Rule, and TILA violations. If your savings projections were based on pre-2017 APS or SRP net metering rates that are no longer accurate, that may constitute material misrepresentation. A free case review identifies your specific options." },
      ...
      { q: "How do I get out of a solar lease in Phoenix?", a: "Getting out of a solar lease in Phoenix typically involves one of three paths: (1) legal cancellation based on misrepresentation or undisclosed terms, (2) buying out the remaining lease balance, or (3) transferring the lease to a buyer if you are selling your home. Legal cancellation is often the most cost-effective option and the one most homeowners do not know about." },
      ...
      { q: "What solar companies have the most complaints in Phoenix?", a: "Based on Arizona AG complaint data and BBB records, the most complained-about solar companies in Phoenix include Sunrun, Vivint Solar (now NRG Clean Power), SunPower (now bankrupt), and Tesla Solar. Common complaints involve undisclosed escalator clauses, dealer fees hidden in loan balances, and savings projections based on outdated net metering rates." },
      { q: "How do I file a complaint about my solar company in Arizona?", a: "File complaints with the Arizona Attorney General's Consumer Protection Division (azag.gov), the FTC (reportfraud.ftc.gov), and the CFPB (consumerfinance.gov/complaint). If your solar company is licensed in Arizona, also file with the Arizona Registrar of Contractors. These complaints create a paper trail and can sometimes prompt faster resolution." },
    ],
  },
  {
    slug: "las-vegas-nv",
