...
const TASKS: Task[] = [
  ...
  { id: "t15", title: "sitemap.xml (171 URLs)", description: "Full sitemap with homepage, 10 blog posts, 8 company pages, 118 city pages, and blog index.", status: "done", impact: "critical", category: "Technical" },
  ...
  { id: "t20", title: "8 company-specific SEO pages", description: "Sunrun, SunPower, Pink Energy, Vivint, Freedom Forever, ADT Solar, Sunnova, GoodLeap — each with complaints, lawsuits, and cancellation guide.", status: "done", impact: "critical", category: "Content" },
  { id: "t21", title: "10 SEO blog articles", description: "Full articles targeting: how to cancel solar contract, red flags, rescission rights, Pink Energy, SunPower, TILA violations, sell home with solar lease, GoodLeap/Mosaic loans, Sunrun guide, solar company bankruptcy.", status: "done", impact: "critical", category: "Content" },
  ...
  // PENDING — I CAN DO
  { id: "p1", title: "Dynamic <title> per page", description: "Each blog post, city page, and company page needs its own unique browser title tag rendered via useEffect. Currently all share the same title.", status: "pending", impact: "critical", category: "Technical", notes: "I can build this in 20 minutes. Just say the word." },
  { id: "p2", title: "Dynamic meta description per page", description: "Same as title — each page needs its own unique meta description injected into <head>.", status: "pending", impact: "critical", category: "Technical", notes: "Pairs with dynamic title fix above." },
  ...
  { id: "p4", title: "Expand to 200+ cities", description: "Add 80+ more mid-size markets: Boise, Fresno, Bakersfield, El Paso, Corpus Christi, Lubbock, Spokane, Tacoma, etc.", status: "pending", impact: "high", category: "Content", notes: "One pass — I can do this immediately." },
  { id: "p5", title: "Add 5 more company pages", description: "Momentum Solar, Titan Solar, Tesla Solar, Palmetto, Sungevity — each has significant complaint volume.", status: "pending", impact: "high", category: "Content", notes: "I can build these now." },
  { id: "p6", title: "Bing Webmaster Tools submission", description: "Submit sitemap to Bing separately — Bing indexes faster than Google for new sites.", status: "pending", impact: "high", category: "Technical", notes: "Requires browser login — I can navigate to the page, you complete the verification." },
  { id: "p7", title: "Wire lead forms to GoHighLevel", description: "Connect all forms (homepage, city pages, company pages, blog CTAs) to GHL webhook for live lead capture.", status: "pending", impact: "critical", category: "Conversion", notes: "Need your GHL webhook URL. I can wire it in 15 minutes once you provide it." },
  { id: "p8", title: "Press release copy", description: "Full press release written and ready to submit to EIN Presswire, PR Newswire, or PRWeb.", status: "pending", impact: "high", category: "Off-Page", notes: "I can write this right now." },
  { id: "p9", title: "10 Reddit seed posts", description: "Helpful answers in r/solar, r/personalfinance, r/homeowners, r/legaladvice linking to specific articles.", status: "pending", impact: "medium", category: "Off-Page", notes: "I can write all 10 posts. Requires your Reddit account to post." },
  { id: "p10", title: "10 Quora answers", description: "Detailed answers to top solar contract questions on Quora with citations to site articles.", status: "pending", impact: "medium", category: "Off-Page", notes: "I can write all 10. Requires your Quora account." },
  { id: "p11", title: "Add 5 more blog articles", description: "Target: 'solar panel removal cost', 'solar contract transfer', 'solar warranty claims', 'solar company reviews', 'solar contract negotiation'.", status: "pending", impact: "high", category: "Content", notes: "I can write and publish these now." },
  { id: "p12", title: "Internal search functionality on blog", description: "Add a search bar to the blog index that filters articles — improves UX and dwell time signals.", status: "pending", impact: "medium", category: "Technical", notes: "I can build this." },
    ...
    <div className="min-h-screen" style={{ background: "oklch(0.09 0.01 265)", fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div className="container py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-10">
          {[
            { label: "Blog Articles", value: 10, icon: <FileText className="w-4 h-4" />, href: "/blog" },
            { label: "City Pages", value: 118, icon: <MapPin className="w-4 h-4" />, href: "/cancel-solar-contract/dallas-tx" },
            { label: "Company Pages", value: 8, icon: <Building2 className="w-4 h-4" />, href: "/cancel-sunrun-solar-contract" },
            { label: "Topic Clusters", value: 5, icon: <Globe className="w-4 h-4" />, href: "/" },
          ].map((item) => (
