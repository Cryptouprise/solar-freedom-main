      ...
      <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-4">
        ...
        <form onSubmit={handleQuickCallback} className="space-y-2.5">
          ...
          <ContactConsentFields
            idPrefix="youtube-quick-callback"
            contactConsent={fallbackContactConsent}
            smsConsent={fallbackSmsConsent}
            website={fallbackWebsite}
        ...
        <div className="container relative z-10 py-16 lg:py-24 max-w-4xl mx-auto">
          ...
          <div className="text-center mb-10">
            ...
            <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1 }}
              ...
              <span className="text-white">REQUEST A REVIEW OF</span>
              <br />
              <span className="text-amber-gradient">YOUR SOLAR AGREEMENT</span>
              <br />
              <span className="text-white">AND SUPPORTING RECORDS.</span>
            </motion.h1>
